...
const Aboutus = () => {
  ...
  const text =
    "ISTE-CGC is the CGC student chapter of the Indian Society for Technical Education (ISTE), a national, non-profit making society registered under the Societies Registration Act of 1860.".split(
      " "
    );
  const text2 =
  ...
  return (
    ...
    >
      <motion.div
        className="text-[clamp(2rem,9vw,7rem)] font-bold py-4 flex flex-col items-center group w-full"
        initial="hidden"
        animate={controls}
        variants={{
      ...
      >
        <div className="flex flex-col items-center group w-full hover:text-[#8B0000] transition-all duration-500 text-center px-2">
          ABOUT US
          <hr
